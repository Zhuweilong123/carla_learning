...
import carla
import math
from Controller import Lateral_LQR_controller, Longitudinal_PID_controller, Vehicle_control
...
Controller = Vehicle_control(ego_vehicle=model3_actor, vehicle_para=vehicle_para, pathway=pathway)  # 实例化控制器
...
while True:
    ...
    """获取障碍物信息"""
    obs_info = obs_detector.obstacle_info
